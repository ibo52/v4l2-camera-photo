...
extern struct v4l2_frmsize_discrete USER_FRAME_SIZE;//user defined width and height frames for camera
/*
*/
...
char*	 camera__imsave(const char* filename);		//dumps buffer data to file
